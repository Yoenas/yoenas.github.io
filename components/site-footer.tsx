        ...
        <div className="flex items-center gap-3">
          {socials.map((social) => (
            <a
              ...
              title={social.label}
              className="flex size-9 items-center justify-center rounded-full border border-border bg-card text-muted-foreground transition-all duration-200 hover:border-foreground hover:bg-secondary hover:text-foreground hover:scale-105"
            >
